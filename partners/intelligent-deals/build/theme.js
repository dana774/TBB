/**
 * Vendored copy of the VGP document design system.
 * Source: client-deliverables/ascend-family-vault/build/theme.js — keep the two in sync.
 * Vendored so this folder resolves a single copy of `docx`; two copies break the
 * library instanceof checks and silently emit an empty document body.
 */
/**
