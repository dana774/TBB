...
| **R.E.D. Academy contract operations** | [`docs/prompts/red-academy-contract.md`](docs/prompts/red-academy-contract.md) | Client engagement, not a build. Pilot Sept 1 – Dec 31 2026, executed 2026-09-16. Activation already run — pick up the existing trackers rather than rebuilding. Hampton Roads bi-weekly is **Fridays** 3:00 PM ET. |
