...
const SEED = {
  ...
  partners: [
    ...
    {
      slug: 'remote-cfo-services',
      name: 'Remote CFO Services',
      type: 'Referral Partner — Fractional CFO & Financial Leadership',
      focus: 'Outsourced/fractional CFO support — financial strategy, forecasting and cash-flow management for growing businesses',
      description: 'Remote CFO Services provides fractional, outsourced CFO support — financial strategy, forecasting, reporting and cash-flow management — giving founders and small businesses senior financial leadership without the cost of a full-time hire.',
      website: 'https://remotecfoservices.com',
      founderName: 'Randy Clinkscale, Principal',
      category: 'Fractional CFO / Financial Leadership',
      bestFit: [
        'Founders needing senior financial leadership without a full-time CFO',
        'Businesses scaling past DIY bookkeeping into real financial planning',
        'Teams that need forecasting, reporting and cash-flow discipline',
      ],
      engagement: ['Fractional / outsourced CFO', 'Financial strategy & forecasting', 'Reporting, KPIs & cash-flow management'],
      whyVgp: 'Hands-on fractional CFO leadership — the financial rigor a founder needs to make confident decisions and get investor-ready.',
      review: true,
    },
    {
      slug: 'christina-david',
      name: 'Christina David',
      type: 'Referral Partner — Accounting & Financial Statements',
      focus: 'Accounting, monthly close and financial-statement preparation for founders and small businesses',
      description: 'Christina David is an accountant supporting founders and small businesses with bookkeeping, monthly close, and financial-statement preparation — the reliable, current financial reporting a growing company needs to stay decision-ready and investor-credible.',
      website: 'https://david.associates',
      category: 'Accounting / Financial Statements',
      bestFit: [
        'Founders who need clean, current financial statements',
        'Small businesses moving past ad-hoc bookkeeping',
        'Teams preparing for funding, tax season or investor review',
      ],
      engagement: ['Bookkeeping & monthly close', 'Financial-statement preparation', 'Quarterly reporting support'],
      whyVgp: 'Dependable, founder-friendly accounting — accurate financials a founder can actually build decisions on.',
      contact: { email: 'cdavid@david.associates' },
      review: true,
    },
    {
      slug: 'harlem-labs',
      name: 'Harlem Labs',
      type: 'Referral Partner — AI & Operations Advisory',
      focus: 'AI implementation and operating systems for lean, service-based businesses',
      description: 'Harlem Labs is a strategic advisory firm that designs integrated AI and automation solutions for service-based businesses — helping founders and operators turn bold ideas into scalable systems, cut operational drag, and grow with a lean, modern tech stack.',
      website: 'https://harlemlabs.com',
      founderName: 'Waziri Garuba, Founder',
      category: 'AI & Operations / Growth Systems',
      bestFit: [
        'Service-based businesses ready to systematize with AI and automation',
        'Founders drowning in manual operations',
        'Teams that want a lean, modern tech stack without the fluff',
      ],
      engagement: ['AI implementation & automation', 'Operating-systems & workflow design', 'Growth-systems advisory'],
      whyVgp: 'A Wall Street-trained operator who turns AI hype into practical systems — a strong match for our Growth OS work with founders.',
      review: true,
    },
    {
      slug: 'veracontent',
      name: 'VeraContent',
      type: 'Referral Partner — Multilingual Content Marketing',
      focus: 'Global, multilingual content marketing and localization for brands scaling across markets',
      description: 'VeraContent is a multilingual content-marketing agency that creates and adapts content in 20+ languages — social media, localization, creative translation and design — with a journalistic editorial process, for brands doing business across markets.',
      website: 'https://veracontent.com',
      founderName: 'Shaheen Samavati, Co-Founder & CEO',
      category: 'Content Marketing / Localization',
      bestFit: [
        'Founders expanding into new languages and markets',
        'Brands that need consistent, high-quality multilingual content',
        'Teams scaling social and content globally',
      ],
      engagement: ['Multilingual content creation & localization', 'Social media management', 'Creative translation & editorial'],
      whyVgp: 'A journalist-founder-led content agency built for the cultural complexity of scaling globally — the content engine international-minded founders need.',
      review: true,
    },
    {
      slug: 'carmona-creative',
      name: 'Carmona Creative',
      type: 'Referral Partner — Creative, Branding & PR',
      focus: 'Branding, design, public relations and social media for small businesses and emerging brands',
      description: 'Carmona Creative is a creative studio for small businesses and emerging brands — branding and design, public relations, social media and casting — helping founders build and elevate a distinctive brand and get it in front of the right audiences.',
      website: 'https://www.carmonacreative.com',
      founderName: 'Luis Carmona, Founder',
      category: 'Creative / Branding / PR',
      bestFit: [
        'Emerging brands needing a cohesive identity',
        'Founders who need PR and media visibility',
        'Small businesses building brand and social presence',
      ],
      engagement: ['Branding & design', 'Public relations & media', 'Social media & casting'],
      whyVgp: '20 years across advertising, marketing and PR — a full-service creative partner for founders getting brand-ready.',
      review: true,
    },
    {
      slug: 'signature-style',
      name: 'Signature Style by Natalie Weakly',
      type: 'Referral Partner — Executive Presence & Personal Brand',
      focus: 'Image consulting and executive presence for founders and professionals',
      description: 'Signature Style, led by Natalie Weakly, helps founders and professionals project executive presence — wardrobe, personal branding, presentation and body language — so they show up with confidence for investor meetings, media and the stage.',
      website: 'https://www.natalieweakly.com',
      founderName: 'Natalie Weakly, Owner',
      category: 'Executive Presence / Personal Brand',
      bestFit: [
        'Founders preparing for investor meetings, media or speaking',
        'Professionals elevating their executive image',
        'Leaders building a confident personal brand',
      ],
      engagement: ['Image & wardrobe consulting', 'Executive presence & presentation', 'Speaking & personal branding'],
      whyVgp: 'Two decades helping professionals in medicine, law and finance project executive presence — the polish founders need when the stakes are high.',
      review: true,
    },
    {
      slug: 'mojo-psg',
      name: 'Mojo PSG',
      type: 'Referral Partner — Growth Marketing & eCommerce',
      focus: 'Growth marketing, eCommerce and integrated brand-building for modern consumer businesses',
      description: 'Mojo PSG is a modern marketing operating partner — strategic advisory, growth marketing, eCommerce, experience design and content — helping consumer brands build demand and scale. Phil Irvine leads eCommerce and growth marketing.',
      website: 'https://mojopsg.com',
      founderName: 'Phil Irvine, Head of eCommerce & Growth Marketing',
      category: 'Growth Marketing / eCommerce',
      bestFit: [
        'Consumer and eCommerce brands scaling demand',
        'Founders needing integrated growth marketing',
        'Teams building modern digital experiences',
      ],
      engagement: ['Growth & performance marketing', 'eCommerce strategy', 'Brand & experience design'],
      whyVgp: 'A modern marketing operating partner with deep eCommerce and growth chops — the demand engine consumer founders need.',
      review: true,
    },
    {
      slug: 'cj-the-beauty-group',
      name: 'CJ The Beauty Group',
      type: 'Referral Partner — Beauty Brand & Product Consulting',
      focus: 'Beauty brand and product/technical consulting rooted in salon artistry and cosmetic science',
      description: 'CJ The Beauty Group, led by Cataanda James, partners with beauty brands on product performance, technical development and positioning — bridging salon artistry and cosmetic science to help brands compete in a crowded, fast-moving industry.',
      founderName: 'Cataanda James, Founder',
      category: 'Beauty / Product & Technical Consulting',
      bestFit: [
        'Beauty and personal-care founders refining product performance',
        'Brands needing technical, formulation-savvy guidance',
        'Founders positioning in a competitive beauty market',
      ],
      engagement: ['Beauty brand consulting', 'Product & technical development guidance', 'Positioning & performance'],
      whyVgp: 'Decades bridging salon artistry and cosmetic science — exactly the technical beauty expertise our personal-care founders need.',
      review: true,
    },
    {
      slug: 'trishelle-lindo',
      name: 'Trishelle Lindo',
      type: 'Referral Partner — LinkedIn Strategy & Storytelling',
      focus: 'LinkedIn strategy and strategic storytelling for founders and small businesses',
      description: 'Trishelle Lindo is a LinkedIn strategist and storytelling consultant — drawing on a media and tech career at CNN, Yahoo!, Oprah.com, BuzzFeed and LinkedIn — who helps founders and small-business owners build presence and tell their story where it counts.',
      website: 'https://trishlindo.com',
      category: 'LinkedIn / Personal Brand & Storytelling',
      bestFit: [
        'Founders building a LinkedIn presence',
        'Small-business owners sharpening their story',
        'Leaders who want strategic visibility',
      ],
      engagement: ['LinkedIn strategy', 'Storytelling & content', 'Personal-brand positioning'],
      whyVgp: 'A LinkedIn insider (and CNN/Yahoo/BuzzFeed alum) who helps founders turn their story into strategic visibility.',
      review: true,
    },
  ],
